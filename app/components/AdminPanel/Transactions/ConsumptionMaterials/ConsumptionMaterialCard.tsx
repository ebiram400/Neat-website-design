...
export default function ConsumptionMaterialCard({onSelectDelete, onSelectEdit ,id ,type ,quantity ,unit ,date }:props){
    ...
    return(
        <div className="relative w-full h-16 overflow-hidden rounded-2xl">
            ...
            >
                <div className="text-sm font-extrabold text-neutral-900">{type}</div>
                <div className="text-xs font-bold text-neutral-800">{quantity + unit}</div>
