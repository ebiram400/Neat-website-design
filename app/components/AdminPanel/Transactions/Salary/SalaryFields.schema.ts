...
export const SALARY_PAYMENTS = ["bank", "cheque", "credit", "catch"] as const;
...
export const SalaryFields = z.object({
  ...
  payment: z.enum(SALARY_PAYMENTS, "نوع پرداخت را تعیین نمایید"),
...
export type SalaryFieldsData = z.input<typeof SalaryFields>;
export type SalaryFieldsPayload = z.output<typeof SalaryFields>;
