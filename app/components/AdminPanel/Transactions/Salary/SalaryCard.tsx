...
export default function SalaryCard({onSelectDelete, onSelectEdit ,id ,position ,amount ,date }:props) {
  ...
  return (
    <div className="relative w-full h-16 overflow-hidden rounded-2xl">
      ...
      >
        <div className="text-sm font-extrabold text-neutral-900">{position}</div>
