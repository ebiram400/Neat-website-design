...
import { BuyMaterialData, BuyMaterialFields, BuyMaterialPayload } from "./BuyMaterialFields.schema";
...
export default function NewTransaction({ pojectId, transactionId }:props ){
    ...
    const units:string[] = ["m","m3","کیسه","نیسان","pcs"];

    const payMethods:string[] = ["bank", "credit", "cheque"];
